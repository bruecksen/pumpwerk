...
class TerraInvoice(models.Model):
    ...
    luxury_sum_7 = models.DecimalField(max_digits=8, decimal_places=2, blank=True, null=True, default=0)
    luxury_sum_19 = models.DecimalField(max_digits=8, decimal_places=2, blank=True, null=True, default=0)
