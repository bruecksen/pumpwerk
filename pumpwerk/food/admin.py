...
class AccountAdmin(admin.ModelAdmin):
    list_display = ('title', 'inventory_date', 'terra_food_others_sum', 'terra_food_others_fee_sum', 'terra_brutto_all_sum', 'food_expenses_pumpwerk_sum', 'terra_food_pumpwerk_fee', 'user_bill_luxury_sum', 'luxury_paid_diff', 'terra_deposit_sum', 'attendance_day_sum', 'previous_terra_daily_rate', 'corrected_terra_daily_rate')
